    ...
    steps: [
      {
        id: 'heat-1',
        title: 'Move to Shade',
        description: 'Move person to shaded or cool area.',
      ...
      },
      {
        id: 'heat-3',
        title: 'Cool Down',
        description: 'Cool with wet cloth or fan.',
        image: 'https://placehold.co/600x400/e2e8f0/1e293b?text=Cool+Down',
        noKitAlternative: 'Use water spray or wet towel.'
      },
      {
        id: 'heat-4',
        title: 'Hydrate',
      ...
      },
      {
        id: 'heat-5',
        title: 'Seek Help',
        description: 'Seek medical help if symptoms persist.',
        image: 'https://placehold.co/600x400/e2e8f0/1e293b?text=Seek+Help',
      }
    ]
  },
    ...
    steps: [
      {
        ...
        description: 'Do not restrain the person.',
        image: 'https://placehold.co/600x400/e2e8f0/1e293b?text=Dont+Restrain',
      },
      {
        id: 'seizure-2',
        title: 'Clear Area',
        description: 'Clear objects nearby.',
        image: 'https://placehold.co/600x400/e2e8f0/1e293b?text=Clear+Area',
      },
      {
        id: 'seizure-3',
        title: 'Protect Head',
        description: 'Place something soft under head.',
        image: 'https://placehold.co/600x400/e2e8f0/1e293b?text=Protect+Head',
        noKitAlternative: 'Use a folded jacket or pillow.'
      },
      {
        id: 'seizure-4',
        title: 'Recovery Position',
        description: 'Turn person on side after seizure.',
        image: 'https://placehold.co/600x400/e2e8f0/1e293b?text=Recovery+Position',
      },
      {
        id: 'seizure-5',
        title: 'Time It',
        description: 'Seek medical help if seizure lasts more than 5 minutes.',
        image: 'https://placehold.co/600x400/e2e8f0/1e293b?text=Time+It',
      }
    ]
  }
];
